...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("enable_depth", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_depth"]),
            DeclareLaunchArgument("enable_color", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_color"]),
            DeclareLaunchArgument("enable_left_ir", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_left_ir"]),
            DeclareLaunchArgument("enable_right_ir", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_right_ir"]),
            ...
            DeclareLaunchArgument("enable_laser", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_laser"]),
            DeclareLaunchArgument("enable_ldp", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_ldp"]),
            DeclareLaunchArgument("enable_point_cloud", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_point_cloud"]),
            DeclareLaunchArgument("enable_colored_point_cloud", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_colored_point_cloud"]),
            DeclareLaunchArgument("enable_sync_output_accel_gyro", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_sync_output_accel_gyro"]),
            DeclareLaunchArgument("enable_publish_extrinsic", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_publish_extrinsic"]),
            DeclareLaunchArgument("enable_accel", default_value=DEFAULT_ORBBEC_STANDALONE_PROFILE["enable_accel"]),
