...
def generate_launch_description():
    ...
    openvins_px4_vision_bridge = Node(
        ...
        parameters=[
            ...
            {"guard_recovery_good_frames": 3},
            {"guard_max_source_gap_s": 0.20},
            {"guard_max_position_step_m": 0.35},
            {"guard_max_implied_speed_mps": 2.0},
            {"guard_max_reported_speed_mps": 2.0},
            {"guard_max_accel_mps2": 5.0},
            {"guard_max_yaw_rate_radps": 3.0},
        ],
    )
