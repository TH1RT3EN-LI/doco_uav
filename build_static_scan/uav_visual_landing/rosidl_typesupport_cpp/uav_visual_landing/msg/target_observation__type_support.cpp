...
static const _TargetObservation_type_support_symbol_names_t _TargetObservation_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uav_visual_landing, msg, TargetObservation)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uav_visual_landing, msg, TargetObservation)),
  }
};
...
{
  return &::uav_visual_landing::msg::rosidl_typesupport_cpp::TargetObservation_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, uav_visual_landing, msg, TargetObservation)() {
  return get_message_type_support_handle<uav_visual_landing::msg::TargetObservation>();
}
